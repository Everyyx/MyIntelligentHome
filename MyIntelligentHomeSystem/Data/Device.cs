...
namespace MyIntelligentHomeSystem.Data
{
    [DataContract]
    public class Device
    {
        ...
        {
            var Response = await I2CHelper.WriteRead(I2C_Slave_Address, I2CHelper.Mode.Mode2, (byte)Pin, 0);
        ...
        {
            var Response = await I2CHelper.WriteRead(SlaveAddress, I2CHelper.Mode.Mode2, (byte)Pin, 1);
            Status = StatusEnum.On;
            return Status;
        }
